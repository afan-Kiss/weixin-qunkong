...
def build_client_detail(client_id: str) -> dict[str, Any]:
    ...
    client = {
        ...
        "hostname": str(meta.get("hostname") or meta.get("host") or "")[:120],
        "host": str(meta.get("host") or meta.get("hostname") or "")[:120],
        ...
        out.append(
            {
                ...
                "hostname": str(r.get("hostname") or r.get("host") or "")[:120],
                "host": str(r.get("host") or r.get("hostname") or "")[:120],
