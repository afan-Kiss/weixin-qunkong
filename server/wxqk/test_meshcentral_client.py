...
class MeshCentralClientTest(unittest.TestCase):
    ...
    def test_build_embed_url_desktop_and_files(self):
        ...
        self.assertIn("wxqkauto=desktop", desk)
        self.assertIn("wxqkauto=files", files)
        self.assertIn("#wxqkauto=desktop", desk)
        self.assertIn("#wxqkauto=files", files)
        self.assertTrue(desk.rstrip().endswith("#wxqkauto=desktop"))
        self.assertTrue(files.rstrip().endswith("#wxqkauto=files"))
